...
plt.savefig('visualization/real_images_G.png', bbox_inches='tight')
plt.close(fig)
...
plt.savefig('visualization/gradient_image_G.png', bbox_inches='tight')
plt.close(fig)
...
fig = plot(samples[0:100])
plt.savefig('visualization/jittered_images_G.png', bbox_inches='tight')
plt.close(fig)
...
fig = plot(samples[0:100])
plt.savefig('visualization/max_features_G.png', bbox_inches='tight')
plt.close(fig)
